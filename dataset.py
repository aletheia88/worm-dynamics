...
class WormDataset(Dataset):
    ...
    def __init__(self, dataset_paths, parameters):

        self.parameters = parameters
        self.input_embeddings = torch.tensor(
                self._assemble_data(dataset_paths), device=parameters.device)
    ...
    def __getitem__(self, index):
        ...
        print(self.input_embeddings.shape)
...
parameters = Parameters(
        ...
        n_embd=2,
        device="cuda:3")
dataset = WormDataset(dataset_paths, parameters)
