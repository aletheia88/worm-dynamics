from assemble import assemble_std_beh
import numpy as np
...
def write_raw_data(ds_name, neuron_classes, behavior_index_dict):
    ...
    assembled_data, datasets = assemble_std_beh(neuron_classes, behavior_index_dict)
...
def split_train_valid_test(
    ds_name, random_seed, split_ratio=[0.7, 0.2, 0.1], save=True
):
    data_dir = "/home/alicia/store1/alicia/attention_predict/data"
...
def write_shuffled_data(ds_name, num_neurons, random_seed, shuffle_type):
    data_dir = "/home/alicia/store1/alicia/attention_predict/data"
    shuffled_data, shuffled_datasets = shuffle(
        ds_name, num_neurons, random_seed, shuffle_type=shuffle_type
    )
